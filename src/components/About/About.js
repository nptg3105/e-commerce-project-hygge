...
const About = () => (
	<div className="container">
		<div className="about">
			...
			<div className="about__features mb-112">
				...
				<div className="about__content">
					<div className="about__item">
						...
						<p className="about__desc">We are always focusing on making all our products as innovative as possible.</p>
					</div>
					<div className="about__item">
						<div className="about__icon">
					...
					<div className="about__item">
						...
						<h3 className="about__title">Teamwork Matters</h3>
						<p className="about__desc">We believe that being a successful company is all about being a team.</p>
					</div>
				</div>
			</div>
