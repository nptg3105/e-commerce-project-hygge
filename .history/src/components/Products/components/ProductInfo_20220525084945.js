			...
			<div className="container">
				...
				{loading ? (
					...
					<div className="product-detail__infor">
						...
						<div className="product-detail__box">
							...
							<h2 className="main-heading">{productDetail.product?.name}</h2>
				...
				<div className="product-detail__features">
					<div className="product-detail__features-title">
						...
						<h2 className="main-heading">Explore the Features</h2>
					</div>
				...
				<div id="related" className="product-detail__related mb-112">
					<p className="sub-heading">- Explore More</p>

					<h2 className="main-heading">Related Products</h2>
					{loading ? (
						<ProductSkeletonList />
					) : (
