					...
					<div className="product-detail__box">
						...
						<div className="product-detail__cart">
							<div className="product-detail__number">
								<i className="product-detail__btn-change" type="button" onClick={() => handleCountChange(-1)}>
									<ArrowBackIosNewIcon />
								</i>
								<p className="product-detail__count">{count}</p>
								<i className="product-detail__btn-change" type="button" onClick={() => handleCountChange(1)}>
									<ArrowForwardIosIcon />
								</i>
							</div>
							<div className="product-detail__add-cart">Add to Cart</div>
