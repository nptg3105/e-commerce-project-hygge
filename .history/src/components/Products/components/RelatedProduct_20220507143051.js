...
import '../RelatedProduct.scss.scss'
...
const RelatedProduct = ({ product }) => {
	...
	return (
		<div className="related_item" onClick={handleClick}>
			<div className="related">
				<img src={product.img} alt={product.name} />
				<p className="related_img-text">Add to Cart</p>
			</div>
			<div className="related_desc">
				<div className="related_name ">{product.name}</div>
				<div className="related_detail">
					<div className="related_category green">{product.category}</div>
