...
import { removeAllItem, removeFromCart } from '../Cart/CartSlice'
...
const Checkout = () => {
	...
	const schema = yup.object().shape({
		...
		phone: yup.number().required('Please enter your phone').typeError('Please enter a numbers'),
				...
				<div className="checkout__box">
					...
					<div className="checkout__detail">
						...
						<div className="login__form">
							<form onSubmit={handleSubmit(submitForm) && dispatch(removeAllItem())}>
