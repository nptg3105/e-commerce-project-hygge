			...
			<section className="section-product-newest mb-112">
				<div className="container product-newest">
					...
					<div className="product-newest__btn">
						<Link to="/products" className="btn btn--primary btn--center">
							View All
						</Link>
					</div>
				</div>
					...
					<div className="blog__box">
						<div className="blog__item blog__item--1">
							<div className="blog__photo">
								<img className="blog__img" src="images/blog1.jpg" alt="blog-photo1" />
							</div>
						...
						<div className="blog__item blog__item--2">
							<div className="blog__photo">
								<img className="blog__img" src="images/blog2.jpg" alt="blog-photo1" />
							</div>
						...
						<div className="blog__item blog__item--3">
							<div className="blog__photo">
								<img className="blog__img" src="images/blog3.jpg" alt="blog-photo3" />
							</div>
						...
						<div className="blog__item blog__item--4">
							<div className="blog__photo">
								<img className="blog__img" src="images/blog4.jpg" alt="blog-photo4" />
							</div>
