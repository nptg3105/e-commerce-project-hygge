...
import ProductSkeletonList from 'components/Products/components/ProductSkeletonList'
		...
		<section className="main">
			...
			<section className="section-category">
				<div className="container category">
					...
					<ChevronLeftIcon />
					<ChevronRightIcon activeItemIndex={active} requestToChangeActive={value => setActive(value)} />
					<ItemsCarousel
						infiniteLoop
						gutter={20}
